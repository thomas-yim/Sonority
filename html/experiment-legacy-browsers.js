...
function surveyInstructionsRoutineBegin(trials) {
  return function () {
    ...
    surveyInstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function ageSurveyRoutineBegin(trials) {
  return function () {
    ...
    ageSurveyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function genderSurveyRoutineBegin(trials) {
  return function () {
    ...
    genderSurveyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function nativeLangSurveyRoutineBegin(trials) {
  return function () {
    ...
    nativeLangSurveyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function otherLangSurveyRoutineBegin(trials) {
  return function () {
    ...
    otherLangSurveyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
